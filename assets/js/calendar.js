...
Calendar.DEFAULT_CONFIG = {
    ...
    MONTHS_LONG: {key:"months_long", value:["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"]},
    WEEKDAYS_1CHAR: {key:"weekdays_1char", value:["S", "M", "T", "W", "T", "F", "S"]},
    WEEKDAYS_SHORT: {key:"weekdays_short", value:["日", "月", "火", "水", "木", "金", "土"]},
...
Calendar.prototype = {
    ...
    */
    ...
    _buildMonthLabel : function(date) {
        ...
        if (this.Locale.MY_LABEL_MONTH_POSITION == 2 || this.Locale.MY_LABEL_YEAR_POSITION == 1) {
            ...
            return  '<p>'+yearLabel+'年 <span>'+ monthLabel+'</span></p>';
        }
    },
    ...
    */
    renderBody : function(workingDate, html) {
        ...
        var cal = this.parent || this;
        om = workingDate.getMonth() != useDate.getMonth(); 
        for (var r = 0; r < 6; r++) {
    ...
    */
    renderCellNotThisMonth : function(workingDate, cell) {
        ...
        cell.innerHTML='<p class="not-month">'+ workingDate.getDate()+'</p>';
        return Calendar.STOP_RENDER;
    },
