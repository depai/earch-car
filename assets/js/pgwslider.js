...
;(function($){
    $.fn.pgwSlider = function(options) {
            ...
            pgwSlider.resizeEvent = setTimeout(function() {
                ...
                if (typeof animate != 'undefined' && animate && pgwSlider.config.maxHeight == null) {
                    ...
                    if (typeof pgwSlider.plugin.find('.ps-current').animate == 'function') {
						...
						pgwSlider.parent().css('height', height);
						if(pgwSlider.slideCount > 9){
							pgwSlider.plugin.find('ul.ps-list').css('height', height);
						}
                    } else {
        ...
        var setup = function() {
            ...
            pgwSlider.plugin.prepend('<div class="ps-current"><ul></ul><span class="ps-caption"></span><span class="count" >1/'+pgwSlider.plugin.find('.ps-list > li').length+'</span></div>');
			...
			if(pgwSlider.slideCount > 11 && ((pgwSlider.slideCount % 3) == 0)){
				pgwSlider.plugin.find('.ps-list').addClass('over_15');
			}else if(pgwSlider.slideCount > 9 && (pgwSlider.slideCount % 3) == 1){
				pgwSlider.plugin.find('.ps-list').addClass('over_13');
			}else if(pgwSlider.slideCount > 9 && (pgwSlider.slideCount % 3) == 2){
				pgwSlider.plugin.find('.ps-list').addClass('over_14');
			}
            // Add controls
        ...
        var fadeElement = function(element) {
            ...
            nextElement.css('position', 'absolute').show().animate({
				...
				pgwSlider.plugin.find('.count').html(pgwSlider.currentSlide + '/' + pgwSlider.slideCount);
            });
        ...
        pgwSlider.nextSlide = function() {
			...
			pgwSlider.plugin.find('.count').html(nextItem + '/' + pgwSlider.slideCount);
			return true;
        };
        ...
        pgwSlider.previousSlide = function() {
			...
			pgwSlider.plugin.find('.count').html(previousItem + '/' + pgwSlider.slideCount);
            return true;
        };
